...
*
* GET请求浏览器发出，其它方法的请求用Postman等接口工具测试。
* POST/PUT/DELETE等请求，硬编码的数据一改变就会引起 notemon运行的程序的重启，所以还是用【 node index.js 】启动服务器吧！！
* 上述增删改的操作，如果数据不是硬编码而是在DB里，还是可以使用notemon命令的
* 发送POST请求添加新数据有几个坑注意一下。
*
*
* */